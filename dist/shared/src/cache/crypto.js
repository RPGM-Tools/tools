...
export async function deriveEncryptionKey(secret, salt, forcePlaintext) {
    ...
    const key = await cryptoApi.subtle.deriveKey({ name: "PBKDF2", salt: saltBuffer, iterations: PBKDF2_ITERATIONS, hash: "SHA-256" }, keyMaterial, { name: "AES-GCM", length: AES_KEY_BITS }, false, ["encrypt", "decrypt"]);
