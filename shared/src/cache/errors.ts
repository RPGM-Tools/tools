...
export class CrystalCacheLockedError extends CrystalCacheError {
	constructor() {
		super(
			'CrystalCache is locked. Call unlock() with fresh credentials before accessing data.'
		);
...
export class CrystalCacheCryptoUnavailableError extends CrystalCacheError {
	constructor() {
		super(
			'Web Crypto API is unavailable. Encryption mode cannot be enabled in this environment.'
		);
